 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 600.0*8/3, 445 }
...
// #define Z_HOMING_HEIGHT  85      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
